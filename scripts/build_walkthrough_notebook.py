...
def build_cells() -> list[dict]:
    ...
    cells.append(md(
        ...
        "",
        "The next cell renders two views of the alpha field at several time",
        "points and embeds them in this notebook:",
        "",
    ...
    cells.append(code(
        "# Render the polar + Cartesian fingers plots for each configuration",
        ...
        "        continue",
        "",
        "    out_polar = cfg_results / \"fingers.png\"",
